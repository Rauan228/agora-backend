...
<div class="mt-6 flex gap-3">
    <button class="bg-gray-900 text-white px-5 py-2 rounded hover:bg-gray-700">Сохранить</button>
    <a href="{{ route('admin.suppliers.index') }}" class="px-5 py-2 rounded border hover:bg-gray-50">Отмена</a>
</div>
