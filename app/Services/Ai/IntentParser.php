...
- Несколько category_slugs = один оптовый заказ из нескольких позиций (короб И лист), не смена темы. Оставляй оба slug.
PROMPT;
    ...
    private const CATEGORY_KEYWORDS = [
        'corrugated-boxes' => ['гофрокороб', 'гофрокороба', 'кофрокороб', 'коробк', 'гофроящик', 'fefco', 'самосбор', 'четырёхклапан', 'четырехклапан', 'гофротара'],
        'corrugated-sheet' => ['гофролист', 'кофролист', 'листовой гофро', 'гофрокартон лист', 'лист гофро'],
